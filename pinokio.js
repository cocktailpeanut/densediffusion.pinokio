...
module.exports = {
  title: "DenseDiffusion",
  description: "Dense Text-to-Image Generation with Attention Modulation",
  icon: "icon.png",
  menu: async (kernel) => {
    let installed = await exists(path.resolve(__dirname, "DenseDiffusion", "env"))
    if (installed) {
